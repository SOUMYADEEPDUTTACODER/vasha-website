...
export default function TTS() {
  ...
  // Automation: Trigger TTS automatically
  useEffect(() => {
    if (autoMode && text && !audioUrl && !loading && !hasAutoGenerated && !error) {
  ...
  }, [autoMode, text, audioUrl, loading, hasAutoGenerated, error, selectedLang, selectedModel])
